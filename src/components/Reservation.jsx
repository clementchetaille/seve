  ...
  return (
    <section className="reservation" id="reservation">
      <div className="resa-text reveal" ref={el => refs.current[0] = el}>
        ...
        <h2>Réservez<br />votre soirée</h2>
        <p>Ouvert du mardi au samedi, midi et soir. Capacité de 36 couverts — nous vous recommandons de réserver.</p>
      ...
      <div className="resa-form reveal reveal-delay-2" ref={el => refs.current[1] = el}>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            ...
            <select defaultValue="2">
              {['1 personne','2 personnes','3 personnes','4 personnes','5 personnes','6+ personnes'].map(v => (
        ...
        <button className="btn-reserve">Confirmer la réservation →</button>
      </div>
    </section>
  )
}
